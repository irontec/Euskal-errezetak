...
use EuskalErrezetakModel as Models;
use EuskalErrezetakMapper\Sql as Mappers;

class EuskalErrezetak_Controller_Plugin_Auth extends Zend_Controller_Plugin_Abstract
{
    /**
     * @var Klear_Bootstrap
     */
