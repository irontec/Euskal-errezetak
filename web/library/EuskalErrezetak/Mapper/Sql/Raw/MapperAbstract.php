...
{
    /**
     * $_dbTable - instance of EuskalErrezetak\Mapper\DbTable\TableAbstract
     *
     * @var EuskalErrezetak\Mapper\DbTable\TableAbstract
     */
    protected $_dbTable;
     ...
     *
     * @param EuskalErrezetak\Mapper\DbTable\TableAbstract $dbTable
     * @return EuskalErrezetak\Mapper\Sql\Raw\MapperAbstract
     */
     ...
     * @param EuskalErrezetak\Model\Raw\ModelAbstract $model
    ...
    public function loadRelated($type, $name, $model, $conditions = null, $orderBy = null)
    {
        ...
        if ('parent' == $type && array_key_exists($name, $parents)) {
            ...
            $table_class = 'EuskalErrezetak\\Mapper\\Sql\\DbTable\\' . $object_table_name;
            $rule = $name;
            ...
            $ref_table_name = 'EuskalErrezetak\\Mapper\\Sql\\DbTable\\' . $object_table_name;
            $rule = $name;
        } else {
        ...
        if ($this->_cache &&
            ...
            $relMapperClassName = "\\EuskalErrezetak\\Mapper\\Sql\\" . $object_table_name;
     ...
     *
     * @see EuskalErrezetak\Mapper\DbTable\TableAbstract::countAllRows()
     ...
     *
     * @see EuskalErrezetak\Mapper\DbTable\TableAbstract::countByQuery()
     ...
     *
     * @param EuskalErrezetak\Model\Raw\ModelAbstract $model The model to delete
     * @return int
     */
    public abstract function delete(\EuskalErrezetak\Model\Raw\ModelAbstract $model);
    ...
    {
        $adapter = new \EuskalErrezetak\Model\Paginator($select, $this);
     ...
     * @return EuskalErrezetak\Model\Raw\ModelAbstract|null
     */
     ...
     * @return array All EuskalErrezetak\Model\Raw\ModelAbstract meeting the criteria
     */
     ...
     * @param EuskalErrezetak\Model\Raw\ModelAbstract|null $model
     * @return EuskalErrezetak\Model\Raw\ModelAbstract|null The matching models found or null if not found
     */
     ...
     *
     * @return EuskalErrezetak\Mapper\DbTable\TableAbstract
     */
     ...
     *
     * @param new EuskalErrezetak\Model\Raw\ModelAbstract $model
     * @return array
     */
     ...
     * @param EuskalErrezetak\Model\Raw\ModelAbstract|null $entry The object to load the data into, or null to have one created
     */
    protected abstract function loadModel($data, $entry);

    /**
     * Cleans urlIdentifier fields, so they can be used as url slugs
     * @param \EuskalErrezetak\Model\Raw\ModelAbstract $model The model to clean
     *
     */
    protected function _setCleanUrlIdentifiers(\EuskalErrezetak\Model\Raw\ModelAbstract $model)
    {
