...
class KlearUsers extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \EuskalErrezetak\Model\Raw\KlearUsers
     */
     ...
     *
     * @return EuskalErrezetak\Mapper\Sql\KlearUsers
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\EuskalErrezetak\Mapper\Sql\KlearUsers')) {

                $this->setMapper(new \EuskalErrezetak\Mapper\Sql\KlearUsers);
     ...
     *
     * @return null | \EuskalErrezetak\Model\Validator\KlearUsers
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\EuskalErrezetak\\Validator\KlearUsers')) {

                $this->setValidator(new \EuskalErrezetak\Validator\KlearUsers);
            }
        }
