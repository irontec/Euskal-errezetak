...
abstract class ModelAbstract implements \IteratorAggregate
{
     ...
     *
     * @var EuskalErrezetak\Model\Raw\ModelAbstract
     */
    protected $_mapper;
    ...
    */
     ...
     *
     * @var EuskalErrezetak\Model\ModelValidatorAbstract
     */
     ...
     *
     * @param array $data
     * @return EuskalErrezetak\Model\Raw\ModelAbstract
     */
     ...
     *
     * @return EuskalErrezetak\Model\Mapper\MapperAbstract
     */
     ...
     *
     * @param EuskalErrezetak\Model\Mapper\MapperAbstract $mapper
     * @return EuskalErrezetak\Model\Raw\ModelAbstract
     */
     ...
     *
     * @see EuskalErrezetak\Mapper\DbTable\TableAbstract::getPrimaryKeyName()
     ...
     *
     * @see EuskalErrezetak\Model\Mapper\MapperAbstract::toArray()
     * @return array
     */
     ...
     * Saves current row
     *
     * @see EuskalErrezetak\Model\Mapper\MapperAbstract::save()
     ...
     *
     * @see EuskalErrezetak\Model\Mapper\MapperAbstract::saveRecursive()
